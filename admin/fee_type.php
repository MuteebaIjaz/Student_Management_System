...
if(isset($_POST['Add'])){
    ...
    $query = "INSERT INTO `fee_types` (`name`, `amount`, `class_id`, `due_date`) VALUES ('$name', '$amount', '$class_id', '$due_date')";
            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Fee Type</li>
                    </ul>
                </div>
        ...
        <div class="registration-container">
            <div class="container-fluid">
                ...
                <form method="POST" action="">
                     <div class="mb-4 w-50">
                       <input type="text" name="name" class="form-control" placeholder="Fee Type Name" required>
                    </div>
                    <div class="mb-4 w-50">
                        <input type="number" name="amount" class="form-control" placeholder="Fee Amount" required>
                    </div>
                    <div class="mb-4 w-50">
                    ...
                    <button type="submit" class="btn btn-primary mb-4" name="Add">Add Fee Type</button>
                </form>
            </div>
        </div>
