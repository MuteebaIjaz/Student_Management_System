    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                        <span class="nxl-mtext">Student</span><span class="nxl-arrow"><i
                                class="feather-chevron-right"></i></span>
                    </a>
                    <ul class="nxl-submenu">
                        <li class="nxl-item"><a class="nxl-link" href="registration_request.php">Registration
                                Requests</a></li>
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="javascript:void(0);" class="nxl-link">
                        <span class="nxl-mtext">Teacher</span><span class="nxl-arrow"><i
                                class="feather-chevron-right"></i></span>
                    </a>
                    <ul class="nxl-submenu">
                ...
                <li class="nxl-item nxl-hasmenu">
                    <a href="mark_attendance.php" class="nxl-link">
